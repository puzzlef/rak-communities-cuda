 ...
 */
template <bool SORT=false, class G, class K>
 ...
 * @returns rak result
 */
template <bool SORT=false, class FLAG=char, class G, class K, class FM>
inline RakResult<K> rakInvokeCuda(const G& x, const vector<K>* q, const RakOptions& o, FM fm) {
  ...
  size_t NL = rakPartitionVerticesCudaU<SORT>(ks, x);
  // Obtain data for CSR.
 ...
 * @returns rak result
 */
template <bool SORT=false, class FLAG=char, class G, class K>
inline RakResult<K> rakStaticCuda(const G& x, const vector<K>* q=nullptr, const RakOptions& o={}) {
  ...
  return rakInvokeCuda<SORT, FLAG>(x, q, o, fm);
}
#pragma endregion
 ...
 * @returns rak result
 */
template <bool SORT=false, class FLAG=char, class G, class K, class V>
inline RakResult<K> rakDynamicFrontierCuda(const G& y, const vector<tuple<K, K>>& deletions, const vector<tuple<K, K, V>>& insertions, const vector<K>* q, const RakOptions& o={}) {
  ...
  return rakInvokeCuda<SORT, FLAG>(y, q, o, fm);
}
#pragma endregion
#pragma endregion
