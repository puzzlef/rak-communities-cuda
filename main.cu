...
void runExperiment(const G& x) {
  ...
  runBatches(x, rnd, [&](const auto& y, auto deletionsf, const auto& deletions, auto insertionsf, const auto& insertions, int sequence, int epoch) {
    ...
    runThreads([&](int numThreads) {
      ...
      auto b1 = rakLowatomicStaticCuda(y, init, {repeat});
      flog(b1, "rakLowatomicStaticCuda");
      ...
      auto b2 = rakLowatomicStaticCuda(y, &d0.membership, {repeat});
      flog(b2, "rakLowatomicNaiveDynamicCuda");
      ...
      auto b4 = rakLowatomicDynamicFrontierCuda(y, deletions, insertions, &d0.membership, {repeat});
      flog(b4, "rakLowatomicDynamicFrontierCuda");
    });
  });
}
