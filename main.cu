...
void runExperiment(const G& x) {
  ...
  runBatches(x, rnd, [&](const auto& y, auto deletionsf, const auto& deletions, auto insertionsf, const auto& insertions, int sequence, int epoch) {
    ...
    runThreads([&](int numThreads) {
      ...
      auto b1 = rakSharedStaticCuda(y, init, {repeat});
      flog(b1, "rakSharedStaticCuda");
      ...
      auto b2 = rakSharedStaticCuda(y, &d0.membership, {repeat});
      flog(b2, "rakSharedNaiveDynamicCuda");
      ...
      auto b4 = rakSharedDynamicFrontierCuda(y, deletions, insertions, &d0.membership, {repeat});
      flog(b4, "rakSharedDynamicFrontierCuda");
    });
  });
}
